                ...
                <div id="main">
                    ...
                    <div id="hero-image-wrapper">
                    	<div id="hero-background-layer" class="parallax-scroll-effect">
                            <div id="hero-bg-image" style="background-image:url('images/Design/Part 20 Design by Aminaart(Fashion Section)2.6.jpg')"></div>
                        </div>
                    </div>                        
                    <!--/Hero Section -->   
                ...
                <footer class="hidden">        	
                    <div id="footer-container">
                        ...
                        <div id="backtotop" class="button-wrap left disable-drag">
                            ...
                            <div class="button-text sticky left"><a href="Design.php">Back to Design</a></div> 
                        </div>
