                ...
                <div id="main">
                    ...
                    <div id="hero-image-wrapper">
                    	<div id="hero-background-layer" class="parallax-scroll-effect">
                            <div id="hero-bg-image" style="background-image:url('images/Miscellaneous/Syed Rashid Ashraf Part 17 Dry Pastels Section1.14.jpg')"></div>
                        </div>
                    </div>                        
                    <!--/Hero Section -->   
                ...
                <footer class="hidden">        	
                    <div id="footer-container">
                        ...
                        <div id="backtotop" class="button-wrap left disable-drag">
                            ...
                            <div class="button-text sticky left"><a href="Miscellaneous.php">Back to Miscellaneous</a></div> 
                        </div>
