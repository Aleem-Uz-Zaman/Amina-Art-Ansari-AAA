                ...
                <div id="main">
                    ...
                    <div id="hero-image-wrapper">
                    	<div id="hero-background-layer" class="parallax-scroll-effect">
                            <div id="hero-bg-image" style="background-image:url('images/The Royals/Kate HighRes Part 5 The Royals 2.jpg')"></div>
                        </div>
                    </div>                        
                    <!--/Hero Section -->   
                ...
                <footer class="hidden">        	
                    <div id="footer-container">
                        ...
                        <div id="backtotop" class="button-wrap left disable-drag">
                            ...
                            <div class="button-text sticky left"><a href="TheRoyals.php">Back to The Royals</a></div> 
                        </div>
